...
namespace CPSC259_2013W2_Lab2_UnitTests
{		
	...
	public:
		...
		TEST_METHOD(Test04_reverse_string_01)
		{
			...
			Assert::AreEqual(strcmp(original, reversed), 0);
		}
		...
		TEST_METHOD(Test05_reverse_string_02)
		{
			...
			reverse_string(original);
			Assert::AreEqual(strncmp(original, reversed, strlen( original) ), 0);
		}
		...
		TEST_METHOD(Test08_reverse_string_06)
		{
		...
		TEST_METHOD(Test09_reverse_string_07)
		{
		...
		TEST_METHOD(Test10_reverse_string_08)
		{
		...
		TEST_METHOD(Test11_contains_sample_01)
		{
			...
			char sample[] = "soup";
			Assert::AreEqual(contains_sample(candidate, sample), 1);
		}

		TEST_METHOD(Test12_contains_sample_02)
		{
			// Let's conduct a positive test for a short candidate and sample
		...
		TEST_METHOD(Test11_contains_sample_03)
		{
			...
			char candidate[] = "Soupspoon";
			char sample[] = "soup";
			Assert::AreEqual(contains_sample(candidate, sample), 0);
		}

		TEST_METHOD(Test12_contains_sample_04)
		{
			// Let's conduct a negative test for a short candidate and sample
		...
		TEST_METHOD(Test13_contains_sample_05)
		{
		...
		TEST_METHOD(Test14_contains_sample_06)
		{
		...
		TEST_METHOD(Test15_contains_sample_07)
		{
		...
		TEST_METHOD(Test16_contains_sample_08)
		{
		...
		TEST_METHOD(Test17_find_index_01)
		{
			// Let's conduct a positive test for a short candidate and sample
			// where the sample is at the beginning of the candidate
			char candidate[] = "soupspoon";
			char sample[] = "soup";
			Assert::AreEqual(find_index(candidate, sample), 0);
		}

		TEST_METHOD(Test18_find_index_02)
		{
			// Let's conduct a positive test for a short candidate and sample
			// where the sample is at the end of the candidate
			char candidate[] = "soupspoon";
			char sample[] = "spoon";
			Assert::AreEqual(find_index(candidate, sample), 4);
		}

		TEST_METHOD(Test19_find_index_03)
		{
		...
		TEST_METHOD(Test20_find_index_04)
		{
		...
		TEST_METHOD(Test21_find_index_05)
		{
			// Let's conduct a negative test
			char candidate[] = "soupspoon";
			char sample[] = "teaspoon";
			Assert::AreEqual(find_index(candidate, sample), -1);
		}

		TEST_METHOD(Test22_find_index_06)
		{
		...
		TEST_METHOD(Test23_find_index_07)
		{
